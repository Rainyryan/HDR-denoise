...
if __name__ == "__main__":
	...
	pretrained_path = "" 
	# pretrained_path = "./distill_models_4/preexpand_hdr_best.pth"
	...
	if phase == "train":
		...
		student_model = Hybrid_Student_HDR(dim=8, num_blocks=[2,2,2,1], num_refinement_blocks=2, heads=[1,2,4,8]) 

		# Load Teacher weights (Assuming you have a trained teacher here)
		teacher_checkpoint_path = "./models_rest_200_999_hi_noise_dim32_4444/preexpand_hdr_best.pth"
		...
		for epoch in range(start_epoch, num_epochs):
			...
			while not improved:
				...
				for i in range(len(dataset)):
					...
					loss_feat = 0
					for key in ["x_level1", "x_level2", "x_latent", "w_level2", "w_level1", "w_level0_refined"]:
